...
int8_t Test_Int8_Min();
int8_t Test_Int8_Zero();
int8_t Test_Int8_Five();
int8_t Test_Int8_Max();

int16_t Test_Int16_Min();
int16_t Test_Int16_Zero();
int16_t Test_Int16_Five();
int16_t Test_Int16_Max();

int32_t Test_Int32_Min();
int32_t Test_Int32_Zero();
int32_t Test_Int32_Five();
int32_t Test_Int32_Max();

int64_t Test_Int64_Min();
int64_t Test_Int64_Zero();
int64_t Test_Int64_Five();
int64_t Test_Int64_Max();

uint8_t Test_Uint8_Min();
uint8_t Test_Uint8_Zero();
uint8_t Test_Uint8_Five();
uint8_t Test_Uint8_Max();

uint16_t Test_Uint16_Min();
uint16_t Test_Uint16_Zero();
uint16_t Test_Uint16_Five();
uint16_t Test_Uint16_Max();

uint32_t Test_Uint32_Min();
uint32_t Test_Uint32_Zero();
uint32_t Test_Uint32_Five();
uint32_t Test_Uint32_Max();

uint64_t Test_Uint64_Min();
uint64_t Test_Uint64_Zero();
uint64_t Test_Uint64_Five();
uint64_t Test_Uint64_Max();

float Test_Float32_Min();
float Test_Float32_Zero();
float Test_Float32_Five();
float Test_Float32_Max();

double Test_Float64_Min();
double Test_Float64_Zero();
double Test_Float64_Five();
double Test_Float64_Max();
